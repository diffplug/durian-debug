...
public class StackDumperTest {
	...
	private void testDumpMethod() {
		...
		assertThat(errOutput).startsWith(StringPrinter.buildStringFromLines(
				"+----------\\",
				"| some message",
				"| at com.diffplug.common.debug.StackDumperTest.testDumpMethod(StackDumperTest.java:103)"));
		assertThat(errOutput).endsWith(StringPrinter.buildStringFromLines(
				"| at com.diffplug.common.debug.StackDumperTest$1.run(StackDumperTest.java:69)",
				"+----------/"));
	}
	...
	public void testDumpFiltered() throws Throwable {
		...
		runWithCleanStack(() -> {
			...
			assertThat(testCaseErr.toString()).isEqualTo(StringPrinter.buildStringFromLines(
					"+----------\\",
					"| some message",
					"| at com.diffplug.common.debug.StackDumperTest$1.run(StackDumperTest.java:69)",
					"+----------/"));
